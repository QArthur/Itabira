...
class Application_Acl_Setup
{
    ...
    protected function _setupResources()
    {
      ...
      $this->_acl->addResource( new Zend_Acl_Resource('monitoring') );
      $this->_acl->addResource( new Zend_Acl_Resource('used-fleet') );
    }
    ...
    protected function _setupPrivileges()
    {
        ...
        $this->_acl	->allow( 'user', 'index', 'index' )
                    ...
                    ->allow( 'user', 'fleet', array('index', 'new', 'view', 'report', 'vis', 'edit', 'remove','review', 'refresh',
                                                    ...
                                                    'report-all','accept-review-edited', 'add-documents', 'duplicate',
                                                    'review-down','accept-down','deny-down','print-inspection','review-add') )
                    ->allow( 'user', 'qco', array('index', 'new', 'view', 'edit', 'report', 'vis', 'new-shape',
                                                    ...
                                                    'consortium-calendar','cell-calendar', 'export', 'remove-route', 'accept-qh',
                                                    'map') )
                    ->allow( 'user', 'mco', array('index', 'new', 'view', 'edit', 'report', 'vis', 'analytics',
                                                    ...
                                                    'main-new-lost-log','consortium-mco','consortium-mco-analytics',
                                                    'consortium-mco-analytics-by-day','consortium-mco-journey-change') )
                    ...
                    ->allow( 'user', 'monitoring', array('index'))
                    ->allow( 'user', 'used-fleet', array('index', 'view','report','report-general', 'report-rit'));
