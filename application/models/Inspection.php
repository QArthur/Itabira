...
class Application_Model_Inspection
{
	...
	public function saveLogInspection($vehicle_id, $action_type)
	{
		try { 
			...
			$data['user'] = $user;
			$inspectionLog = new Application_Model_DbTable_VehicleInspectionLog();
			$inspectionLogNew = $inspectionLog->createRow($data);
			$inspectionLogNew->save();
